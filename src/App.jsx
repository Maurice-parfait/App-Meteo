...
const VIEWS = {
  VIEW1: "view1",
  VIEW2: "view2",
  VIEW3: "view3", // views pour le mobile
};
    ...
    bg-cover bg-center w-ful max-md:overflow-auto max-md:h-screen max-sm:grid-cols-1 max-sm:fixed max-sm:w-full">
      ...
      {activeview === "view1" && (
        <>
          ...
          max-sm:h-[90vh]">
            {/* colonne 1 Grideux */}
            <section className="rounded-xl min-w-[90%] h-auto overflow-auto scrollbar scrollbar-none max-lg:overflow-visible max-lg:scrollbar-default max-md:overflow-visible max-md:scrollbar-default
